...
class economic_evaluation():
    ...
    def __init__(self, distance_from_shore, energy_price, project_duration,
        ...
        self.energy_price = energy_price                # [Euro/MWh]
    ...
    def calculate_cash_flow(self):
        ...
        for i in range(self.project_duration + 1):
            ...
            if i == 0:
                ...
                self.CWF.append(self.energy_price * self.aep_vector - self.project_costs_sums["ABEX"] - self.project_costs_sums["OPEX"])

            else:
                self.CWF.append(self.energy_price * self.aep_vector - self.project_costs_sums["OPEX"])
